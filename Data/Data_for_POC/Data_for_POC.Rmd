...
Assembled in **Prepare data for POC.R**, the **Data_for_POC folder** contains data for the temporal (and spatial where applicable*) trends for the 6 shift indicators, calculated based on Atlantic halibut abundance estimates form SDM output. 
...
6. Distance from COG to border : the shortest path (without crossing land) from the COG to the nearest point on the international border 
...
### Trends in Centre of Gravity
```{r COG plot, echo=FALSE, fig.width=6, fig.height=4}
