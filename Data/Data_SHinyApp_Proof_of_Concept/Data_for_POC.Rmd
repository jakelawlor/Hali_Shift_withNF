...
Assembled in **Prepare data for POC.R**, the **Data_SHinyApp_Proof_of_Concept folder** contains data for the temporal (and spatial where applicable*) trends for the 6 shift indicators, calculated based on Atlantic halibut abundance estimates form SDM output. All data have been subset to spring estimates.
