...
setequal(trends_Region1, trends_Region1.2)
...
# trends_Region1.4$one <- 1
# trends_Region2.4$one <- 1
# 
# # -----------------------------------------------------------
# # 2. Domains for left/right pies (NEW compared to original)
# # -----------------------------------------------------------
...
# #    - Now we create a left (CAN) and right (Region2) version.
# # -----------------------------------------------------------
# 
# # --- Region1 logos (left pie) ---
# pie_images_Region1 <- lapply(seq_len(n), function(i) {
#   list(
#     source  = logo_files[i],
...
# )
# 
# # --- Region2 logos (right pie) ---
# pie_images_Region2 <- lapply(seq_len(n), function(i) {
#   list(
#     source  = logo_files[i],
#     xref    = "paper",
#     yref    = "paper",
...
# all_images <- c(
#   pie_images_Region1, list(center_image_Region1),
#   pie_images_Region2, list(center_image_Region2)
# )
# 
# # -----------------------------------------------------------
# # 5. ONE figure with TWO pies (instead of subplot(p_Region1, p_Region2))
# # -----------------------------------------------------------
# 
...
#   hoverlabel = ~paste0(metric),
#   marker = list(
#     colors = colors_Region1,      # <<< DIFFERENCE: vector, not ~colors_Region1
...
#   # ---- Right pie (Region2) ----
# add_pie(
#   data = trends_Region23,
#   labels = ~metric,
#   values = ~one,              # <<< NEW: same trick for Region2
#   hole = 0.25,
#   text = ~text,
#   textinfo = "none",
#   hoverlabel = ~paste0(metric),
#   marker = list(
#     colors = colors_Region2,
#     line = list(color = "grey20", width = 2)
#   ),
#   hoverinfo = "text",
#   sort = FALSE,
